...
# Grupa5 / 08 / P2 â Osoba -> Radnik, Student (OBAVEZNO)
# âââââââââââââââââââââââââââââââââââââââ
...
if __name__ == '__main__':
    osobe = [
        ...
        Radnik("Marko", "M.", 30, "SportTech", "AnalitiÄar", 140000),
        Student("Ana", "P.", 21, "FFK", "Sportski menadÅ¾ment"),
    ]
    print("=== Polimorfizam ===")
    for o in osobe:
        print(f"  [{type(o).__name__}] {o}")
    s = osobe[2]
    s.polozi("Statistika", 9)
    s.polozi("MenadÅ¾ment", 10)
